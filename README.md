## Hopes and dreams:
- [x] Hello Create React App
- [x] Create simple component & nest in app
- [ ] Incorporate Redux
- [ ] Experiment with directory structures
- [ ] Figure out how to handle styling
- [ ] Handle API calls without UI looking like crap
- [ ] Move a react component between codebases to ensure react component portability
- [ ] Write simple tests in jest
- [ ] Move on to React Native ☎️  
- [ ] Celebrate with fine wine and victuals :bowtie: :wine_glass: 🍗 
